...
<body id="page-top">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <p class="lead">Coronavirus disease (COVID-19) is an infectious disease caused by a newly discovered
            ...
            problem like cardiovascular disease.</p>
          <p class="lead">The COVID-19 virus spread primarily through droplet of saliva or discharge from the nose when
            an infected person coughs or sneezes so it’s important that you also practice respiratory etiquette.</p>
  ...
  <section id="symptoms" class="bg-light">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
