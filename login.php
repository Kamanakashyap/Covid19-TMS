    ...
    <div class="container">
        ...
        <div class="row justify-content-center ">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9 h-100">
                <h3 align="center" style="margin-top:4%;color:#fff;font-weight:800">Covid Testing Management System</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="small text-info" href="password-recovery.php"
                                                style="font-weight:bold">Forgot Password?</a>

                                        </div>

                                        <div class="text-center">
                                            <a class="small text-info" href="index.php" style="font-weight:bold;"><i
